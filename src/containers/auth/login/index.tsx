    ...
    <Modal open={isOpen} onClose={props.onClose} closeAfterTransition>
      <Fade in={isOpen}>
        <Wrapper>
          <InfoSide>
            <div className="main">
              <h1>Đăng nhập để Review Chất:</h1>
              <div className="info">
                {CommentElement}
                <p>
              ...
              <div className="info">
                {NewsElement}
                <p>
                  <strong>Tạo bài viết</strong> của riêng bạn
                </p>
              </div>
              <div className="info">
                {NotiElement}
            ...
            <div className="footer">
              <p>© 2023 TechRv, Review Chất giữ bản quyền nội dung trên website này.</p>
            </div>
          </InfoSide>
          <LoginSide>
            <div className="grid-header">
              <div role={'button'} className="close-button" onClick={() => router.back()}>
                <CloseButton />
              </div>
            </div>
            <div className="grid-body">
              ...
              <div role="button" className={'login-button google'} onClick={() => signIn('google')}>
                {GoogleIconElement}
...
const InfoSide = styled.div`
  padding: 48px 32px;
  background: ${themeColor('primary')}44;
...
const LoginSide = styled.div`
  ...
  > .grid-footer {
    ...
    a {
      ...
      font-weight: 500;
      &:hover {
        color: ${(p) => lighten(themeColor('link')(p) as string, 0.2)};
      }
    }
  }
`;
